              ...
              <div className="group rounded-3xl border border-white/10 bg-[#0e121a]/90 p-6 sm:p-8 backdrop-blur-xl transition-all duration-300 hover:border-[#14b8a6]/40 hover:bg-[#111722]">
                ...
                <div className="flex flex-wrap gap-2">
                  {cat.items.map((skill) => (
                    <span
                      key={skill}
                      className="rounded-lg border border-white/5 bg-white/[0.03] px-3 py-1.5 font-mono text-xs text-[#94a3b8] transition-all duration-200 hover:border-[#14b8a6]/40 hover:text-white hover:bg-[#14b8a6]/10"
                    >
                      {skill}
                    </span>
                  ))}
